...
class BarLoungeController extends Controller
{
    /**
    ...
    {
        return view('root.bar-lounge.index');
    }
    ...
    {
        return view('root.bar-lounge.create');
    }
    ...
    public function store(Request $request)
    {
		...
		$requestData['type'] = Page::TYPE_BAR_LOUNGE;

        $page = Page::create($requestData);

        Session::flash('flash_message', 'Coffee added!');

        return redirect('root/bar-lounge');
    }
    ...
    public function show($id)
    {
        ...
        return view('root.bar-lounge.show', compact('page'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('root.bar-lounge.edit', compact('page'));
    }

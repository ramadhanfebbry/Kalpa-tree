...
class RestaurantController extends Controller
{
    ...
    {
        return view('root.restaurant.index');
    }
    ...
    {
        return view('root.restaurant.create');
    }
    ...
    public function store(Request $request)
    {
		...
		$requestData['type'] = Page::TYPE_RESTAURANT;

        $page = Page::create($requestData);

        Session::flash('flash_message', 'Coffee added!');

        return redirect('root/restaurant');
    }
    ...
    public function edit($id)
    {
        ...
        return view('root.restaurant.edit', compact('page'));
    }

...
@section('title', 'Menus')
@section('description', 'Menus Management')
@section('breadcrumbs', Breadcrumbs::render('menus'))
...
$("#menus-table_wrapper > .dt-buttons").appendTo("div.export-options-container");
...
function hapus(){
    ...
    var id = $('#did').val();
    $.ajax({
        url: '{{url("root/menus")}}' + "/" + id + '?' + $.param({"_token" : '{{ csrf_token() }}' }),
        type: 'DELETE',
